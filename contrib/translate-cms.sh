...
( 
  translate-objects.sh content_management_system content $from $to translate_yandex
  translate-objects.sh content_management_system meta_title $from $to translate_google
)
