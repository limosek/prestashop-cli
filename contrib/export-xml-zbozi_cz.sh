...
eval $(pslist -Fenvarr '--delete-characters=;"' products 'reference!=' "$@" price reference weight id_category_default description_short description name ean13 manufacturer_name id_default_image)
